...
module.exports.builder = function(yargs) {
  ...
  return yargs
    ...
    .option('allow-remote', {
      alias: 'R'
    , describe: 'Whether to allow remote devices in dmc. Highly ' +
    ...
    .option('port', {
      alias: ['p', 'poorxy-port']
    , describe: 'The port dmc should run at.'
    , type: 'number'
    , default: 7100
    })
    .option('provider', {
    ...
    .epilog('Each option can be be overwritten with an environment variable ' +
      ...
      'underscores and prefixing it with `dmc_LOCAL_` (e.g. ' +
      '`dmc_LOCAL_ALLOW_REMOTE`).')
}
